This is test task that's have been done by the task that described in the (README.md)[./README.md] file The setup include ` React + TypeScript + Vite + Jest + tailwindcss`
